  ...
  <b-row style="margin-left: 0;margin-right: 0;">
    ...
    <b-col md="8">
      <h2 class="intro animate__animated animate__fadeInUp animate__fast">
        Hi 👋,
        <br />I<span>'m Lutfir&nbsp;Rahman</span>.
      </h2>

      <div class="col-md-10 info">
        A <b>front-end developer</b> passionate about solving problems with
        tech.<br />
        I am skilled with building exceptional <b>websites</b>, and currently
        i'm exploring the web server.
        <br />
        <b-button
...
export default {
  ...
  data() {
    return {
      ...
      socialLinks: {
        github: "https://github.com/lutfir2019",
        linkedin: "https://www.linkedin.com/in/lutfir-rahman-67ba97202/",
        twitter: "",
        facebook: "",
        mail: "mailto:lutfirrahman2001@gmail.com",
        youtube: ""
      }
    };
  },
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "Lutfir Rahman is an awesome front-end developer and technical writer, passionate about building solutions that works across multiple platforms with high accessibility approach. Elijah has vast knowledge in web development with over 3+ years experience in building actual products"
      },
      {
        hid: "og:title",
        name: "og:title",
        content: "Portfolio ⚡ - Lutfir Rahman"
      },
      {
