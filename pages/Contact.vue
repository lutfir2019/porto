        ...
        <b-form class="mb-5" @submit.prevent="sendMessage">
          ...
          <b-form-group id="input-group-3" label="Your Message">
            <b-form-textarea
              ...
              no-resize
              rows="3"
              placeholder="Watsup Lutfir, are you available for.."
              required
            ></b-form-textarea>
          </b-form-group>
...
export default {
  ...
  methods: {
    async sendMessage(e) {
      ...
      await fetch("https://formspree.io/f/mayggdpp", {
        method: "POST",
        body: data,
        headers: {
  ...
  head: {
    title: "Contact 📧 - Lutfir Rahman",
    meta: [
      {
        hid: "description",
        name: "description",
        content: "Do you have any enquires? Send a message now to Lutfir Rahman"
      },
      {
        hid: "og:title",
        name: "og:title",
        content: "Contact 📧 - Lutfir Rahman"
      },
      {
